...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://87260929956826",
...
local v8 = CreateObject("TextLabel", {
    ...
    Parent = v6,
    BackgroundTransparency = 1,
    Text = "Youtube: huybaone✅️ Roblox",
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/huybaone✅️roblox");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://87260929956826") then
                    return v729;
                end
            end
        end
